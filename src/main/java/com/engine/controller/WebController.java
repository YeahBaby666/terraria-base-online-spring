...
public class WebController {
    ...
    public String createRoom(@RequestParam String name, 
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("successMessage", "Room '" + name + "' created successfully. Now go edit!");
            return "redirect:/editor?room=" + newRoom.getId(); 
    ...
    public String editor(@RequestParam(required = false) String room, Model model, 
        ...
        if (room != null && !room.isEmpty()) {
            Optional<GameRoom> gameRoom = gameRoomService.findRoomById(room);
    ...
    /**
     * Serves the client play view. Loads the three raw design components for direct execution.
    ...
    public String play(@RequestParam(required = false) String room, Model model,
        ...
        if (room != null && !room.isEmpty()) {
            ...
            if (gameRoom.isPresent()) {
                ...
                // PASAMOS LOS TRES SCRIPTS DE FORMA SEPARADA PARA SU INYECCIÓN DIRECTA EN PLAY.HTML
                model.addAttribute("clientStructureHtml", gr.getClientStructureHtml());
                model.addAttribute("clientRenderScript", gr.getClientRenderScript());
                model.addAttribute("clientInputScript", gr.getClientInputScript());
